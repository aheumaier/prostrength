...
workouts = Workout.create!([{ title: 'Upper-Body-1-intensification', created_by: felix.id },
                            { title: 'Upper-Body-2-intensification', created_by: felix.id },
                            { title: 'Lower-Body-2-intensification', created_by: felix.id },
                            { title: 'Lower-Body-1-intensification', created_by: felix.id }])
